...
describe('expand tree graph patterns', function () {
    ...
    it('should expand the optional properties of the first depth level', function () {
        ...
        expect(gp.getUnionPatterns()[0].optionalBranch('disco:parent')[1].getUnionPatterns()[0].getTriples()).toContain([mapping.getComplexProperty('Parent').getVariable(), 'disco:id', mapping.getComplexProperty('Parent').getElementaryPropertyVariable('Id')]);
